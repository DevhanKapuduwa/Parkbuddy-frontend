  ...
  Widget build(BuildContext context) {
    return Consumer<Shop>(
      builder: (context, value, child) {
        print("Cart content: ${value.cart}"); // Debugging line
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final park = item['park'] as Park;
                          final quantity = item['quantity'] as int;
                          final reservationDate = item['date'] as DateTime?;
                          final reservationTime = item['time'] as String;
                          final totalPrice = int.parse(park.price) * quantity;

                          print(
                              "Reservation Date: $reservationDate"); // Debugging line
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  if (reservationDate != null)
                                    Text(
                                      "Date: ${reservationDate.toLocal()}"
                                              .split(' ')[
                                          0], // Display reservation date
                                      style: TextStyle(
                                        color: Colors.grey.shade300,
                                      ),
                                    ),
