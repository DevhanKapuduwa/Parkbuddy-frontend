...
import 'package:plz/components/List_tiles/Booking_view.dart';
...
class BookingsTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>Booking_clicked(Current_booking: currentBooking,)));
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Car Park: ${currentBooking.parkName}',
